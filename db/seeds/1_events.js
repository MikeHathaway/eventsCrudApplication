  ...
  return knex('events').del()
    .then(function () {
      return knex('events').insert([
        ...
        {id: 2, venues_id: 2, title: 'Creativity Conference 2017', description: 'Cautiously converse catchprashes concerning creativity!', over_21: false, start_datetime: new Date('2017-07-20 14:26:16 UTC'), end_datetime: new Date('2017-07-28 14:26:16 UTC')}
      ]);
    })
    .then(() => {
      return knex.raw(
